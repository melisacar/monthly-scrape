...
from models import Flights, Base, engine, Session
    ...
    try:
        ...
        for href in hrefs:
            try:    
                ...
                print(f"{href} error while processing file: {e}")
                continue
        ...
        print(f"An error occurred in the main_all function: {e}")
